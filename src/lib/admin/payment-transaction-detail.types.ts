...
export const PAYMENT_PURPOSE_LABELS: Record<string, string> = {
  ...
  creator_film_upload_apple_iap: "Creator per-film upload (Apple IAP)",
  creator_distribution_license: "Creator distribution licence",
  creator_distribution_license_apple_iap: "Creator distribution licence (Apple IAP)",
  viewer_subscription_apple_iap: "Viewer subscription (Apple IAP)",
  viewer_ppv_apple_iap: "Viewer pay-per-view (Apple IAP)",
