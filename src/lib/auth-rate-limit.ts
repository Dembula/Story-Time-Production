...
export function enforceSignupRateLimit(request: NextRequest) {
...
function peekCredentialSignInIpRate(request: NextRequest) {
...
async function peekCredentialSignInEmailRate(request: NextRequest) {
  ...
  const ipRate = peekCredentialSignInIpRate(request);
