...
export default function CrewTeamLayout({
  children,
}: {
    ...
    <div className="min-h-screen bg-[#0c1222]">
      <header className="border-b border-slate-800 px-6 md:px-12 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/crew-team/dashboard" className="text-xl font-semibold text-white">
            <span className="text-emerald-500">STORY TIME</span> Crew Team
          </Link>
          <button
