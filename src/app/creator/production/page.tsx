      ...
      footerSection={
        <section className="storytime-section space-y-2 p-5 md:p-6">
          ...
          <p className="text-xs text-slate-500">
            Book shoot catering from the On-Set Catering tool — browse company menus and galleries, request bookings, and pay through Story Time. Pre-production handles cast, crew, locations, equipment, and funders.
          </p>
        </section>
      }
    />
