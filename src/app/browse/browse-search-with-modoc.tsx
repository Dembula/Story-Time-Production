        ...
        <form onSubmit={submitSearch} className="flex flex-1 gap-2">
          <div className="relative flex-1">
            <input
              ...
              className="w-full rounded-2xl border border-white/10 bg-white/[0.05] px-4 py-3 text-white shadow-panel placeholder:text-slate-500 focus:border-orange-400/40 focus:outline-none focus:ring-2 focus:ring-orange-500/40"
              autoComplete="off"
            />
            {showDropdown && query.trim().length < 2 && (recentSearches.length > 0 || TRENDING.length > 0) && (
              <div className="absolute left-0 right-0 top-full z-40 mt-2 overflow-hidden rounded-2xl border border-white/10 bg-[#0a0f18] shadow-2xl">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {TRENDING.map((term) => (
                      <button
                        ...
                        className="rounded-full bg-white/5 px-2.5 py-1 text-xs text-slate-300 hover:bg-white/10 hover:text-white"
                      >
                        {term}
                      </button>
                    ))}
          ...
          <select
            ...
            className="rounded-2xl border border-white/10 bg-white/[0.05] px-3 py-3 text-sm text-white focus:border-orange-400/40 focus:outline-none"
