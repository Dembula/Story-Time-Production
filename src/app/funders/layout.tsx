    ...
    <DashboardSidebarShell
      ...
      sidebarFooter={
        <>
          ...
          <button
            onClick={handleSignOut}
            className="flex w-full items-center justify-center gap-1 rounded-lg border border-red-900/50 bg-red-950/30 px-3 py-2 text-xs text-red-300 transition hover:bg-red-900/35"
          >
            <LogOut className="h-3.5 w-3.5" />
            Logout
          </button>
