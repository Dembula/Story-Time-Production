  ...
  const talent = await prisma.castingTalent.create({
    data: {
      ...
      bio: embedMeta(body.bio ?? null, {
        ...
        contactEmail: profile.contactEmail ?? body.contactEmail ?? null,
        agentName: profile.agentName ?? null,
        unionStatus: profile.unionStatus ?? null,
        height: profile.height ?? body.height ?? null,
        weight: profile.weight ?? body.weight ?? null,
        eyeColor: profile.eyeColor ?? null,
        hairColor: profile.hairColor ?? null,
        ethnicity: profile.ethnicity ?? body.ethnicity ?? null,
        gender: profile.gender ?? body.gender ?? null,
        specialSkills: profile.specialSkills ?? [],
        portfolioUrl: profile.portfolioUrl ?? null,
        socialLinks: profile.socialLinks ?? [],
        travelWillingness: profile.travelWillingness ?? null,
        driversLicense: profile.driversLicense ?? null,
