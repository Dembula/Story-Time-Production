...
export async function GET() {
  try {
    ...
    console.error("GET /api/viewer/profiles/active", e);
    return NextResponse.json({ error: "Failed to load active profile" }, { status: 500 });
  }
}
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("POST /api/viewer/profiles/active", e);
