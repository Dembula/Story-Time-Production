...
export function BrowseMobileNav() {
  ...
  return (
    <motion.nav
      ...
      className="fixed bottom-0 left-0 right-0 z-40 border-t border-white/12 bg-[linear-gradient(180deg,rgba(8,12,22,0.72),rgba(8,12,22,0.86))] px-2 pb-[max(env(safe-area-inset-bottom),0.45rem)] pt-2 backdrop-blur-2xl md:hidden"
    >
