  ...
  return (
    <section className="border-t border-white/8 px-4 py-14 sm:px-6 sm:py-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-10 sm:mb-16 grid gap-4 sm:gap-6 md:grid-cols-2 xl:grid-cols-4">
          {ecosystemItems.map((item, i) => (
            <LandingReveal key={item.label} delay={i * 0.06}>
              <div className="storytime-panel group rounded-[1.45rem] p-5 sm:p-6 hover:-translate-y-1 hover:border-orange-400/20 hover:bg-white/[0.04]">
